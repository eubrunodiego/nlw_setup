...
- [x]  Front-end
    ...
    - [x]  Sincronizando hábitos completos
    - [x]  Adicionando `transitions` e `focus`
    - [x]  Como levar o projeto para o próximo nível?
        - [x]  Ideia 1 - Autenticação (`Firebase`, `Auth0`)
        - [x]  Ideia 2 - Notificações `Push` / `Service Workers`
        - [x]  Ideia 3 - Perfil público com gráfico de resumo
- [x]  Mobile
    - [x]  `Habit`
        - [x]  Buscar os hábitos do dia selecionado na `API`
        - [x]  Exibir a lista de hábitos do dia
        - [x]  Criar o component `HabitsEmpty`
        - [x]  Exibir o progresso do hábito
        - [x]  Verificar se data selecionada é passada e mostrar mensagem: não pode editar
    - [x]  Enviar para a `API` o estado do hábito
        - [x]  Utilizar o `useFocusEffect` para atualizar a `Home` ao voltar
    - [x]  Animação
        - [x]  Conhecendo o `React Native Reanimated`
        - [x]  Instalando e configurando o `Reanimated`
